...
Prado_sim3 = function(s1, s2, Nsim, Dfactor, tvcov,flag_ASE=1,flag_DW=0)
{
tt = proc.time()
...
r1 = 0.1*1:N/N + 0.85
r2 = -0.1*1:N/N + 0.95
at = 0.8*( 1 - 0.5*cos(pi*(1:N)/N) )
AA1 = AA2 = array(0,c(4,N))

AA1[1,] = r1 * cos(2*pi/(15*1:N/N+5))
AA2[1,] = -r1^2

AA1[2,] = r2 * cos(2*pi/(-10*1:N/N+15))
AA2[2,] = -r2^2
...
ASE2 = rep(0,Nsim)
CH   = rep(0,Nsim)
SP1 = array(0,c(52,1020))
SP2 = array(0,c(52,1020))
Ch = array(0,c(52,1020))
...
Prado_sim1r = function(Ar, casem, cases, Nsim, Dfactor, tvcov,flag_ASE=1,flag_DW=0)
{
tt = proc.time()
